...
¡Ha acertado!
 */
package java_poo_ej05_guia7extras;
import Entidad.Meses;
import javax.swing.JOptionPane;

public class JAVA_POO_Ej05_Guia7Extras {

    public static void main(String[] args) {
        
        Meses adivinanza = new Meses();
        String mes = JOptionPane.showInputDialog("Escriba el nombre del mes");
        JOptionPane.showMessageDialog(null, "A ver si adivinaste el mes secreto!!!!");
                
        while(!mes.equalsIgnoreCase(adivinanza.getMesSecreto())){
            JOptionPane.showMessageDialog(null, "Perdiste. Seguí participando...");
            mes = JOptionPane.showInputDialog("Escriba el nombre del mes");
        }
            JOptionPane.showMessageDialog(null, "ADIVINASTE, Sos un genio!!!!!");
    }
